...
const useAnimationLoop = (
  ...
  useEffect(() => {
    ...
    if (!track || (isVertical ? seqHeight === 0 : seqWidth === 0)) return;
    ...
    const animate = (timestamp) => {
      ...
      // Se o frame for muito longo (aba do navegador em background), resetamos o delta
      if (deltaTime > 0.1) {
      ...
      // Cálculo do offset (o operador % garante o loop infinito)
